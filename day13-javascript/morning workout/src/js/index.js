...
const number000256784 = '790';
const number000986056 = '5600';
const number001546238 = '78065';
const number030987456 = '120910';


const balance = prompt('Enter your bank account number');
const action = prompt('What would you like to do');

if (action === balance) {
  if (balance === '000256784') {
    alert(number000256784);
  } else if (balance === '000986056') {
    alert(number000986056);
  } else if (balance === '001546238') {
    alert(number001546238);
  } else if (balance === '030987456') {
    alert(number030987456);
  }

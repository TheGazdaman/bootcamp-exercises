...
class Snails {
  ...
  render() {
    ...
    this.element.className = 'snail__racer';
    this.element.innerHTML = (
      `<svg class="snail" id="${this.name}" viewBox="0 0 260 200" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="snail__racer__name">${this.name}</div>`
  ...
  update() {
    const nameSnail = this.element.querySelector('.snail__racer__name');
    nameSnail.textContent = this.name;

    const snailColor = this.element.querySelector('.snail__shell');
    snailColor.style.fill = this.color;
  }
